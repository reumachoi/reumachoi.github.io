...
- 최상단 경로에 있는 패키지들 범위에서 참조하는 패키지들을 `node_modules/.pnpm` 폴더에 정리합니다.
  ![]({{site.url}}{{site.baseurl}}/assets/img/2023-12-13-nestjs-pnpm-mono-repo/pnpm_1.png)
  ![]({{site.url}}{{site.baseurl}}/assets/img/2023-12-13-nestjs-pnpm-mono-repo/pnpm_2.png)
...
![]({{site.url}}{{site.baseurl}}/assets/img/2023-12-13-nestjs-pnpm-mono-repo/pnpm_3.png)
